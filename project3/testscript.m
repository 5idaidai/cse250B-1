...
tic;
[thetas,phis,GibbsData,alphas,betas] = lda(bag, voc, words, numTopics, numEpochs, percCutOff);
TimeSpent = toc;
...
if dataset==1
    save('c400Data.mat','GibbsData','thetas','phis','alphas','betas','percCutOff','voc');
else if dataset==2
        save('20nData.mat','GibbsData','thetas','phis','alphas','betas','percCutOff','voc');
    end
end
